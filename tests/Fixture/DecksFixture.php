...
class DecksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'text', 'length' => null, 'default' => null, 'null' => true, 'collate' => null, 'comment' => '名称', 'precision' => null],
        'user_id' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => true, 'comment' => 'デッキid', 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
